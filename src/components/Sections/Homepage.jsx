...
<motion.div animate={{opacity:[0,1]}} transition={{duration:3, delay:1, repeat:0}} class= "w-full flex justify-center h-[300px] bg-yellow-" > 
    ...
    <div ref={carousel} class="w-[97%]  scroll-smooth  overflow-x-auto overflow-y-hidden p-0 whitespace-nowrap h-[100%] no-scrollbar snap-x snap-mandatory  ">
        ...
        <div class="w-[98%] snap-center inline-block mr-3 mt-4 h-[93%] bg-[url('/Images/WTMWBanner.png')] bg-contain bg-[#FFEAF7] bg-no-repeat bg-center rounded-[18px] shadow-[inset_0_0_0px_1px_#000000]"></div>
        <div class="w-[98%] bg-[url('/Images/RecommendedMovie/BigHero6.jpeg')] bg-contain  bg-center bg-red-400 snap-center mr-3 inline-block mt-4 h-[93%] rounded-[18px] shadow-[inset_0_0_15px_5px_#000000]">
        ...
        <div class="w-[98%] bg-[url('/Images/snhu_logo_new.png')] bg-contain bg-no-repeat bg-center bg-white snap-center bg mr-3 inline-block mt-4 h-[93%] rounded-[18px] shadow-[inset_0_0_0px_1px_#000000]"></div>

        

        <div class="w-[98%] bg-[url('/Images/createdbyBanner.png')] bg-contain bg-no-repeat bg-center bg-black snap-center bg mr-3 inline-block mt-4 h-[93%] rounded-[18px] shadow-[inset_0_0_15px_5px_#000000]"></div>
    ...
    <div class="h-[30%] flex items-center justify-center bg-blue-  w-full ">
    ...
    <div class="flex items-center h-[228px] pb-2 mt-[13px] bg-  ">
      <CarouselComponent>
